...
// Validate ../../src/app/api/admin/jobs-reset/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/jobs-reset">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/jobs-reset/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
